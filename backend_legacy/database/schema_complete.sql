-- Complete Database Schema for Balingasag Library
-- This file contains all tables for the library management system
...
-- QR Attendance Table (QR Code Check-in/Check-out)
...
CREATE INDEX idx_qr_attendance_user ON qr_attendance(user_id);
CREATE INDEX idx_qr_attendance_date ON qr_attendance(time_in);
CREATE INDEX idx_qr_attendance_status ON qr_attendance(status);
